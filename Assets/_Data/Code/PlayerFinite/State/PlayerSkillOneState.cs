...
public class PlayerSkillOneState : PlayerBaseState
{
    ...
    public override void UpdateState(PlayerStateManager player)
    {
        ...
        if ((player.PlayerControl.CheckCurrentAnimation(PlayerStateManager.Player_Skill, 0.9f, 1) || (player.PlayerControl.CheckCurrentAnimation(PlayerStateManager.Player_T_Skill_One, 0.9f, 1))))
        {
